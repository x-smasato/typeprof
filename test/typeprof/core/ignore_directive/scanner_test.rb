  ...
  module Core
    module IgnoreDirective
      class ScannerTest < Test::Unit::TestCase
        ...
        def test_when_only_inline_enable
          src = <<~RUBY
            def foo
              x = 1 # typeprof:enable
              y = 2
        ...
        def test_when_only_line_block_disable
          src = <<~RUBY
            def foo
        ...
        def test_when_line_block_disable_no_enable
          src = <<~RUBY
            def foo
              # typeprof:disable
              x = 1
        ...
        def test_when_line_block_disable_and_enable
          src = <<~RUBY
            def foo
              # typeprof:disable
              x = 1
        ...
        def test_when_block_disable_and_inline_enable
          src = <<~RUBY
            def foo
              # typeprof:disable
              x = 1
        ...
        def test_when_multiple_directives
          src = <<~RUBY
            def foo
              # typeprof:disable
              x = 1
