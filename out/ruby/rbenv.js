...
exports.Rbenv = void 0;
const path = __importStar(require("path"));
const fs_1 = require("fs");
const versionManager_1 = require("./versionManager");
class Rbenv extends versionManager_1.VersionManager {
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            const rbenvPath = yield this.findRbenvInstallation();
            if (!rbenvPath) {
    ...
    findRbenvInstallation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const possiblePath of possiblePaths) {
                if (possiblePath && (0, fs_1.existsSync)(path.join(possiblePath, 'bin', 'rbenv'))) {
                    return possiblePath;
                }
            }
            ...
            for (const dir of pathDirs) {
                ...
                if ((0, fs_1.existsSync)(rbenvPath)) {
