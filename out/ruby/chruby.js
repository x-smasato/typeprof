...
exports.Chruby = void 0;
const path = __importStar(require("path"));
const fs_1 = require("fs");
const versionManager_1 = require("./versionManager");
class Chruby extends versionManager_1.VersionManager {
    activate() {
        return __awaiter(this, void 0, void 0, function* () {
            const chrubyPath = yield this.findChrubyInstallation();
            if (!chrubyPath) {
    ...
    findChrubyInstallation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const possiblePath of possiblePaths) {
                if (possiblePath && (0, fs_1.existsSync)(path.join(possiblePath, 'bin', 'chruby-exec'))) {
                    return possiblePath;
                }
            }
            return undefined;
...
exports.Chruby = Chruby;
//# sourceMappingURL=chruby.js.map